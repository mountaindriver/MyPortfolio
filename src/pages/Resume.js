    ...
    <section id="resume" className="resume">
      <div className="container">
        <div className="section-title">
          ...
          <a href="../assests/resume/Resume Lucas Freigenberg.pdf" download>
            Download📝
          </a>
        </div>
        ...
        <div className="row">
          <div className="col-lg-6" data-aos="fade-up">
            ...
            <div className="resume-item pb-0">
              ...
              <p>
                <em>
                  ...
                  contributing my creativity, problem-solving and determination
                  to develop user-centric and innovative web solutions that make
                  a meaningful impact.
                </em>
              </p>
              <ul>
            ...
            <div className="resume-item">
              ...
              <p>
                ...
                dedication to academic excellence and my commitment to achieving
                outstanding results.
              </p>
            </div>
            <div className="resume-item">
              ...
              <h5>2022</h5>
              <p>
                <em>University of Utah, Salt Lake City, Utah</em>
              </p>
              <p>
                ...
                diligently completed every assignment. This experience showcases
                my leadership, dedication, and strong work ethic in mastering
                the skills required for full stack development.
              </p>
            </div>
          </div>
          <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div className="resume-item">
              ...
              <ul>
                ...
                <li>
                  ...
                  Management (CRM) system, enhancing client interaction and data
            ...
            <div className="resume-item">
              ...
              <h5>2023</h5>
              <p>
                <em>Livnot U'Lehibanot, Tzfat, Israel</em>
              </p>
              <ul>
                <li>
